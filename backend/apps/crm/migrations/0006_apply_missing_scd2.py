...
class Migration(migrations.Migration):
    dependencies = [("crm", "0005_scd2_constraints_patch")]

    operations = [
        migrations.RunSQL(
            sql="""
            CREATE UNIQUE INDEX IF NOT EXISTS entity_uid_current_uniq
            ON entity (entity_uid) WHERE is_current = true;
            """,
        ...
        migrations.RunSQL(
            ...
            ON entity_detail (entity_uid, detail_code) WHERE is_current = true;
            """,
        ...
        migrations.RunSQL(
            sql="""
            DROP INDEX IF EXISTS entity_detail_value_json_gin;
            CREATE INDEX entity_detail_value_json_gin
            ON entity_detail USING gin (value_json jsonb_path_ops);
            """,
